...
public class IrodsCorsFilter implements ContainerRequestFilter,
	...
	protected void preflight(final String origin,
			final ContainerRequestContext requestContext) throws IOException {
	...
	protected void checkOrigin(final ContainerRequestContext requestContext,
			final String origin) {
	...
	private void parseAllowedOriginsFromConfiguration() {
		...
		allowedOrigins = myOrigins;

	}

	private void parseAllowCredentialsFromConfiguration() {
		allowCredentials = restConfiguration.isCorsAllowCredentials();
	}
